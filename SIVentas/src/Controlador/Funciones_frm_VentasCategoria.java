 ...
 * @author Nestor1
 */
public class Funciones_frm_VentasCategoria extends Modelo.Consultas_informeMasVendido{
    ...
    public  Constructores.Constructor_Cantidad_Categoria_Vendido llenarMasVendido(int id_sucursal)
   {
       ...
       Modelo.Consultas_VentasCategorias con = new Consultas_VentasCategorias();
    ...
    public TableModel modeloTablaCantidadCategoria(int id_sucursal)
    {
