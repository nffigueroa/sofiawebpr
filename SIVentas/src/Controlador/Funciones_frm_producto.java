 ...
 * @author Nestor1
 */
public class Funciones_frm_producto extends Modelo.consultas_Producto{
   ...
   public TableModel llenarProductos(int sucursal,String[] nombreColumnas, int[] ancho)
   {
       Grillas gr = new Grillas();
       return gr.CargarGrd(llenarTabla_Producto(sucursal), nombreColumnas, ancho);
   }
   ...
   public void eliminarProducto(int id_prod)
   {
    ...
    public boolean insertarProducto(String nombre,String fecha_creacion,String usuarioCreacion, Object categoria , Object marca, Object medicion , Object presentacion )
    {
        Funciones_Generales fun = new Funciones_Generales();
        usuari=fun.usuario(usuarioCreacion);
        ...
        registrarProducto(nombre, fecha_creacion, usuari.getId_usuario(), id_categoria, id_marca, id_medicion, id_presentacion,usuari.getId_sucursal());
        return false;
    }
