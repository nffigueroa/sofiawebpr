...
import Modelo.Consultas_VentasCategorias;
import Modelo.Consultas_informeMasVendido;
import Modelo.consultas_Cliente;
 ...
 * @author Nestor1
 */
public class Funciones_Generales extends Modelo.Consultas_Generales {
    ...
    public Constructores.Constructor_Cantidad_Categoria_Vendido listadoCategoriasProducto() {
        int aux = 0, filas = 0;
        Modelo.Consultas_VentasCategorias fun = new Consultas_VentasCategorias();
    ...
    public Constructo_Cantidad_Productos_Vendido listadoProductoInventario(int id_sucursal) {
        ...
        int aux = 0, filas = 0;
        Modelo.Consultas_informeMasVendido fun = new Consultas_informeMasVendido();
...
//    }
    ...
    public Constructor_Mi_empresa datosMiEmpresa(int id_sucursal) {
        ...
        Modelo.consultas_factura col = new Modelo.consultas_factura();
    ...
    public Constructor_usuario_permiso permisosUsuario(int id_usuario) {
        ...
        Modelo.consultas_usuario usu = new Funciones_frm_Usuario();
