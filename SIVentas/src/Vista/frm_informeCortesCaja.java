 ...
 * @author Nestor1
 */
public class frm_informeCortesCaja extends javax.swing.JInternalFrame {
     ...
     */
    public frm_informeCortesCaja(Object usua) {
    ...
    private void parametrosTabla() {
        ...
        columnas[6] = "% INTERES";
        columnas[7] = "CUOTAS";
        columnas[8] = "CUOTAS/PAGAS";
        columnas[9] = "CUTOAS/PENDIENTES";
        columnas[10] = "ESTADO";
        columnas[11] = "USUARIO";
        columnas[12] = "FECHA";
        columnas[13] = "HORA";
...
//        columnas_eliminar[5] = 15;
    ...
    private void cargarTable() {
        ...
        try {
            tbl_cortes.setModel(n.funcionLlenarCredito(mi_empresa.getId_empresa(), columnas, ancho_columnas));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        for (int i = 0; i < columnas_eliminar.length - 1; i++) {

            tbl_cortes.getColumnModel().removeColumn(tbl_cortes.getColumnModel().getColumn(columnas_eliminar[i]));
        }
    ...
    private void buscarCredito() {
        ...
        parametrosTabla();
        try {
            tbl_cortes.setModel(n.funcionBuscarCredito(mi_empresa.getId_empresa(), comboBox, txt_buscar_credito.getText(), columnas, ancho_columnas));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void abonarCredito() {
        ...
        int id_credito = 0;
        id_credito = Integer.parseInt(tbl_cortes.getModel().getValueAt(tbl_cortes.getSelectedRow(), 0).toString());
    ...
    private void initComponents() {
        ...
        tbl_cortes = new javax.swing.JTable();
        ...
        tbl_cortes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbl_cortes.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbl_cortesKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_cortes);
    ...
    private void tbl_cortesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbl_cortesKeyPressed
        // TODO add your handling code here:
          if(evt.getKeyChar()==KeyEvent.VK_ENTER)
          {
              abonarCredito();
          }
    }//GEN-LAST:event_tbl_cortesKeyPressed
    ...
    private javax.swing.JTable tbl_cortes;
