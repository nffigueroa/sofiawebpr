...
import Controlador.Funciones_Venta_Mensual;
...
public class frm_venta_mensual_informe extends javax.swing.JInternalFrame {
    ...
    {
        Controlador.Funciones_Venta_Mensual fun = new Funciones_Venta_Mensual();
    ...
    private void graficarDatos()
    {
       ...
       int fila = 0;
        ...
        chart = ChartFactory.createBarChart("VENTA MENSUAL", "VENTAS", "CANTIDAD", data, 
