 ...
 * @author Nestor1
 */
public class frm_HistorialInforme extends javax.swing.JInternalFrame {
 public String []columnas_inventario = new String[30];
     ...
     */
    public frm_HistorialInforme (Object usuario) {
    ...
    private void cargarTable() 
    {
        ...
        try{
        tbl_historial.setModel(n.llenarHistorial(usuario_activo.getId_sucursal(),columnas, ancho_columnas));
        }
        catch(Exception ex) 
        {
            ex.printStackTrace();
    ...
    private void cargarTableBuscar() 
    {
        ...
        try{
        tbl_historial.setModel(n.buscarHistorial(usuario_activo.getId_sucursal(),txt_buscar_historial.getText(),cmb_buscar_por_historial.getSelectedItem().toString(),columnas, ancho_columnas));
        }
        catch(Exception ex) 
        {
            ex.printStackTrace();
    ...
    private void exporatPdf()
    {
        ...
        String ruta = "src\\Reportes\\reporteHistorial.jasper";//RUTA DONDE TIENEN SU REPORTE --
        int id_empresa = 0;
        consultarDatosUsuario();
...
//                JOptionPane.showMessageDialog(null, "Esto puede tardar unos segundos,espere porfavor", "Estamos Generando el Reporte", JOptionPane.WARNING_MESSAGE);
    ...
    private void initComponents() {
        ...
        cmb_buscar_por_historial.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Proceso", "Usuario", "Fecha" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel2)))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btn_exportarPdf, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
