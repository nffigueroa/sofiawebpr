 ...
 * @author Nestor1
 */
public class Funciones_Login extends DA.consultas_login{
   ...
   private SimpleDateFormat date = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public Object encriptadorSemilla (Object objeto)
    {
        return encrip.encrypt(objeto.toString());
    }
    
    public Object desencriptadorSemilla (Object objeto)
    {
        return encrip.decrypt(objeto.toString());
    }
