 ...
 * @author Nestor1
 */
public class Funciones_Marca_BF extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       StringBuilder sb = new StringBuilder();
        ...
        switch (opcion) {
            case 1: {
                Funciones_marca pro = new Funciones_marca();
                try {
                    boolean ban = pro.insertarMarca(obJ.getString("marca"),
            ...
            case 4 :  // consulta Categoria
            {
                ...
                ArrayList lista = pro.llenarTablaMarca();
            ...
            case 5 :
            {
                ...
                Funciones_marca pro = new Funciones_marca();
                JSONArray resultJson = new JSONArray();
                ArrayList lista = pro.InsertarRelacionMarcaSucursal(obJ.getJSONObject("marca"), 
            ...
            case 6 :
            {
                Funciones_marca pro = new Funciones_marca();
                JSONArray resultJson = new JSONArray();
                ArrayList lista = pro.llenarTablaMarcaRelacion(obJ.getInt("idSucursal"));
                resultJson.put(0,lista);
                response.getWriter().print(resultJson);
                break;
            }
