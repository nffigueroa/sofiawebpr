 ...
 * @author Nestor1
 */
public class Funciones_frm_CajonDinero extends DA.consultas_importe{
   ...
   ResultSet rs = null; 
    public ArrayList llenarComboTpoimporte()
    {
        try {
          rs = consultaLLenarComboTipoImporte();
...
//        return aux;
    ...
    public ArrayList llenarComboMotivoImporte(Object tipoImporte)
    {
        try {
            rs = consultaLLenarComboMotivoImporte(tipoImporte);
            return general.resultSetToArrayList(rs);
        } catch (Exception e) {
            return null;
        }
...
//        return aux;
    ...
    public boolean registarImporte(int id_succursal,Object tipoImporte,Object motivoImporte, Object importe, Object descripcio,int id_usuario)
    {
       ...
       // id_Motivo_Importe = consultaIDComboMotivoImporte(motivoImporte);
        ...
        if(consultaRegistrarImporte(id_succursal,tipoImporte, motivoImporte, importe, descripcio))
        return true;
        else
            return false;
    }
