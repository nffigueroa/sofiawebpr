...
public class Funciones_frm_producto extends DA.consultas_Producto{
   ...
   public ArrayList listarMarcasRegistradas(int idSucursal)
   {
       
       try {
           Funciones_marca marca = new Funciones_marca();
            rs = marca.llenarTabla_MarcaRelacionSucursal(idSucursal); // capa de datos del hilo Marca
            return general.resultSetToArrayList(rs);
        } catch (Exception e) {
            return null;
        }
   ...
   public void eliminarProducto(int id_prod)
   {
     ...
     public ArrayList llenarComboMarca(int idSucursal)
    {
        try {
            rs = consultaLLenarComboMarca(idSucursal);
            return general.resultSetToArrayList(rs);
        } catch (Exception e) {
            return null;
        }
    ...
    public ArrayList llenarComboCategoria(int idSucursal)
    {
        try {
            rs = consultaLLenarComboCategoria(idSucursal);
            return general.resultSetToArrayList(rs);
        } catch (Exception e) {
            return null;
        }
